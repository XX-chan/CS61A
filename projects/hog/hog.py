...
def roll_dice(num_rolls, dice=six_sided):
    ...
    "*** YOUR CODE HERE ***"
    # END PROBLEM 1
    assert num_rolls>0 ,"num_rolls at leaet once."
    k,total=0,0
    pig_out=False
    while k<num_rolls:
        roll=dice()
...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    assert type(opponent_score)==int and type(player_score)==int, 'Illegal value for sides'
    if opponent_score//10<0:
        opponent==0
    else :
        opponent=(opponent_score//10)%10
    player=player_score%10
    score=abs(opponent-player)*3
    return max(1,score)
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    strategy=boar_brawl(score,opponent_score)
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    strategy=sus_update(0,score,opponent_score,dice=six_sided)
    update_score=strategy-score
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    while score>opponent_score:
        average=make_averaged(roll_dice,times_called=1000)
        average_0=average(0,dice=six_sided)
        average_six=average(6,dice=six_sided)
        if average_0>average_six:
            return 0
        else:
            return 6
    # END PROBLEM 12
